...
const uint16_t BITMAP_BACKGROUND_DAY_ID = 3;
const uint16_t BITMAP_BACKGROUND_NIGHT_ID = 4;
const uint16_t BITMAP_BIRD__ID = 5;
const uint16_t BITMAP_PIPE_ID = 6;
const uint16_t BITMAP_PIPE_BOTTOM_ID = 7;
